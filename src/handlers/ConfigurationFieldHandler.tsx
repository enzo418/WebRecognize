...
export default class ConfigurationFieldHandler implements IConfigurationFieldHandler {
    ...
    update<T>(value: T): void {
        this.parent.update({ field: this.field, path: this.field }, {fieldService: this, value});
    }
