...
export default class LiveViewBox extends React.Component<LiveViewBoxProps, LiveViewBoxState> {
    ...
    updateLiveFeed() {
        ...
        liveViewService.getCameraView(this.props.uri)
            .ok(data => {
                this.setState({
        ...
        return <>
            { this.state.error.length == 0 && (this.state.loading ?
                ...
                <LiveView
                    ...
                    onLoad={() => { }} style={this.props.style}></LiveView>)
            }
