...
export default function DetectionCameraConfiguration() {
    ...
    const [cameraResize, setCameraResize] = useState<Size>({width: 0, height: 0});
            ...
            <Grid item xs={12} sm={12} md={6}>
                <Stack direction="row">
                    <TextConfigurationField
                            ...
                            type="number"
                            fullWidth
                            data={{...commonData, path: 'increaseThresholdFactor'}}
                    />
                ...
                <Box>
                    ...
                    <Stack direction="row" spacing={{xs: 1, md: 2}}>
                        <TextConfigurationField
                            ...
                            type="number"
                            fullWidth
                            data={{...commonData, path: 'processingConfiguration/resize/width'}}
                        />
                        ...
                        <TextConfigurationField
                            ...
                            type="number"
                            fullWidth
                            data={{...commonData, path: 'processingConfiguration/resize/height'}}
                        />
                    </Stack>
